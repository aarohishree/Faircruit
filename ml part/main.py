...
class ExamSystem:
    ...
    def display_results_terminal(self):
        ...
        cv_rec = self.cv_evaluation.get('recommendation', 'N/A')
        print(f"\nOVERALL FEEDBACK: {feedback[:200]}...")
        print(f"CV FIT: {cv_rec}\n")
    ...
    def generate_reports(self):
        ...
        print(f"Admin Report: {report_filename}")
        print(f"\nOverall Score: {self.evaluation.get('overall_score', 0)}/100")
        print(f"CV Fit: {self.cv_evaluation.get('recommendation', 'N/A')}")
